...
var MapsLib = {
  ...
  fusionTableId:      "1nLSsq2WNTPz5B2ZmEANUZBJ409cUl9CKVwzCHgP9",

  //*New Fusion Tables Requirement* API key. found at https://code.google.com/apis/console/
  //*Important* this key is for demonstration purposes. please register your own.
  googleApiKey:       "AIzaSyAR7EJFDqasvYS7_dRmXnw9LMRbbXvjvtE",
  ...
  map_centroid:       new google.maps.LatLng(41.85294, -87.627106), //center that your map defaults to
  ...
  doSearch: function(location) {
    ...
    //-----custom filters-------
      var type_column = "'Categories'";
      var tempWhereClause = [];
      if ( $("#mural").is(':checked')) tempWhereClause.push("Mural");
      if ( $("#community").is(':checked')) tempWhereClause.push("Community Engagement");
      if ( $("#sculpture").is(':checked')) tempWhereClause.push("Sculpture");
      whereClause += "AND" + type_column + "IN ('"+ tempWhereClause.join("','") + "')";
      
      
      
      if ( $("#select_type").val() != "")
          whereClause += " AND 'Decade' = '" + $("#select_type").val() + "'";
...
getList: function(whereClause) {
    var selectColumns = "Title, Year, Decade, Categories";
